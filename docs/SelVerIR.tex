...
\title{SelVerIR: Self-Verifying Programming Language \\ Intermediate Representation Syntax and Semantics Document \\ v0.6}
...
\begin{enumerate}
    ...
    \item After a finite number of non-erroneous execution steps, which are proven correct in this section, program reaches an error state; but by section \textbf{2.2.4} of this document and the operational semantic rule of high-level \texttt{SelVeri} language $[ \text{err}_{\text{os}} ]$ the remaining finite execution is also correct.
\end{enumerate}
