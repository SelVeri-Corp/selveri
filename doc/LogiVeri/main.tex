...
To support the logic programming capabilities of \texttt{LogiVeri}, we extend the core grammar of \texttt{SelVeri}. We introduce a mechanism to evaluate specifications as standard boolean expressions, and a new arithmetic (logic) expression to query the solver for existential witnesses.
...
\newpage
\section{Determinism analysis for LogiVeri}
...
\textbf{Theorem:} The introduction of the \texttt{obtain} expression renders the \texttt{LogiVeri} language semantically non-deterministic.
