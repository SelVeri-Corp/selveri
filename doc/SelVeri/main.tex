...
\title{SelVeri: Self-Verifying Programming Language \\ High Level Language Syntax and Semantics Document \\ v0.9.1}
...
\begin{table}[!ht]
\centering
\renewcommand{\arraystretch}{1.3} % Significantly increased global line spacing
\makebox[\textwidth][c]{%
\begin{tabular}{|r l|}
\hline
