...
\begin{cases}
\langle c,\, e,\, \sigma[x \mapsto \textbf{0}],\, s[x \mapsto t],\, pc+1 \rangle \\ \qquad \text{if } x \in \textbf{Var} \;\land\; t \in \{\texttt{INT}, \texttt{REAL}\} \;\land\; s(x) = \textbf{Void}\\
\end{cases} \\
...
\langle c,\, e,\, \sigma[x \mapsto \textbf{0}],\, s[x \mapsto \texttt{LIST[REAL, $n$]}],\, pc+1 \rangle \\ \qquad \text{if } x \in \textbf{Var} \;\land\; t = \texttt{LIST[REAL]}]\;\land\; s(x) = \textbf{Void}\\
...
\langle c,\, \sigma(x,s) : e,\, \sigma,\, s,\, pc+1 \rangle & \\ \qquad \text{if } s(x) \in \{\texttt{INT}, \texttt{REAL}\} \land n=1 \land v_1 \in \mathbb{R} \land x \in \textbf{Var} \\[2pt]
...
\langle c,\, e,\, \sigma[x \mapsto v_0],\, s,\, pc+1 \rangle & \\ \qquad \text{if } s(x) \in \{\texttt{INT}, \texttt{REAL}\} \land n=0 \land v_0 \in \mathbb{R} \land x \in \textbf{Var} \\[2pt]
